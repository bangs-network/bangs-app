...
const VerseDetail: React.FC<MenuProps> = ({history, match}) => {
    ...
    const getData = (ev?: any) => {
        ...
        console.info("===========> get data::: ",ev,params.id);
    ...
    //     const itemDiv = document.getElementById(`renderRow_${index}`);
    //     if(itemDiv){
    //         return itemDiv.clientHeight;
    //     }
    //     return 150
    // }
    ...
    const renderRow = (item1,index1,ref?:any) => {
        ...
        return <div key={index1} ref={ref}  style={{
            ...
            <div  className='cursor'
                 style={{
                     background: item1.timelineType != 1 ? '#fff':item1.theme.BackgroundColor,
            ...
            >
                {
                    item1.timelineType == 1 ? item1.mainPic ?
                        <div className="theme-img" style={{background:item1.theme.BackgroundColor}}>
    ...
    return (
        <IonPage id='about-page'>
            ...
            <IonContent ref={contentRef} scrollEvents={true} onIonScroll={(e) => {
                // scrollToTop(e)
                ...
                {/*{*/}
                {/*    timeList && <VerseItems dataArr={timeList} renderItem={renderRow} sticky={{*/}
                {/*        height: 200,*/}
                {/*        render: (index)=>{*/}
